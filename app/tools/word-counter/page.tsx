      ...
      <main className="mx-auto max-w-5xl px-4 py-10 sm:px-6 lg:px-8">
          ...
          <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
            <div>
              ...
              <p className="mt-1 text-sm text-gray-500">
                Statistics update automatically as you type or paste
                text.
              </p>
            </div>
          ...
          <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
            <div className="rounded-2xl border border-gray-200 bg-white p-5 shadow-sm">
              ...
              <p
                ...
                aria-label={`${stats.words.toLocaleString()} words`}
              >
            ...
            <div className="rounded-2xl border border-gray-200 bg-white p-5 shadow-sm">
              ...
              <p
                className="mt-2 text-3xl font-bold text-gray-900"
                aria-label={`${stats.characters.toLocaleString()} characters`}
              >
            ...
            <div className="rounded-2xl border border-gray-200 bg-white p-5 shadow-sm">
              ...
              <p
                className="mt-2 text-3xl font-bold text-gray-900"
                aria-label={`${stats.charactersNoSpaces.toLocaleString()} characters without spaces`}
              >
            ...
            <div className="rounded-2xl border border-gray-200 bg-white p-5 shadow-sm">
              ...
              <p
                className="mt-2 text-3xl font-bold text-gray-900"
                aria-label={`${stats.sentences.toLocaleString()} sentences`}
              >
            ...
            <div className="rounded-2xl border border-gray-200 bg-white p-5 shadow-sm">
              ...
              <p
                className="mt-2 text-3xl font-bold text-gray-900"
                aria-label={`${stats.paragraphs.toLocaleString()} paragraphs`}
              >
            ...
            <div className="rounded-2xl border border-gray-200 bg-white p-5 shadow-sm">
              ...
              <p
                className="mt-2 text-3xl font-bold text-gray-900"
                aria-label={`${stats.lines.toLocaleString()} lines`}
              >
            ...
            <div className="rounded-2xl border border-gray-200 bg-white p-5 shadow-sm">
              ...
              <p
                className="mt-2 text-3xl font-bold text-gray-900"
                aria-label={`${stats.readingTime} minute estimated reading time`}
              >
                {stats.readingTime}
        ...
        <section className="mt-10 rounded-2xl border border-gray-200 bg-white p-6 sm:p-8">
          ...
          <ol className="mt-5 space-y-4 text-sm leading-6 text-gray-600">
            ...
            <li>
              <strong className="text-gray-900">2. Review the statistics.</strong>{" "}
              The tool automatically calculates words, characters,
              sentences, paragraphs, and lines.
            </li>

            <li>
              <strong className="text-gray-900">3. Check reading time.</strong>{" "}
              The estimated reading time uses an approximate reading
              speed of 200 words per minute.
            </li>

            <li>
              <strong className="text-gray-900">4. Copy or clear the text.</strong>{" "}
          ...
          <div className="mt-5 grid gap-6 sm:grid-cols-2">
            <div>
              ...
              <p className="mt-2 text-sm leading-6 text-gray-600">
                ...
                text around whitespace characters such as spaces,
        ...
        <section className="mt-6 rounded-2xl border border-gray-200 bg-white p-6 sm:p-8">
          ...
          <div className="mt-4 space-y-4 text-sm leading-7 text-gray-600">
            <p>
              The Word Counter performs its calculations in your
              browser as you type or paste text into the tool.
            </p>
