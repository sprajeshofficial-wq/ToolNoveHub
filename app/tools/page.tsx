...
const ALL_TOOLS = [
  ...
  {
    name: 'JSON Validator',
    description: 'Validate JSON data and find syntax errors.',
    icon: FileJson,
  ...
  return (
    <div className="min-h-screen py-20 px-4 bg-gradient-to-br from-slate-50 via-white to-indigo-50/30">
      <div className="mx-auto max-w-7xl">
        ...
        {/* Popular Tools Section - Only show when no search */}
        {!searchQuery && (
          <div className="mb-12">
        ...
        {hasResults ? (
          ...
          // No results message - only show when search has no results
