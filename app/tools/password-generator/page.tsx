...
export const metadata: Metadata = {
  ...
  keywords: 'password generator, strong password, random password, secure password, password creator, online password generator, password maker, random password generator',
  alternates: {
