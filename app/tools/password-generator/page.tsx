        ...
        <div className="mx-auto max-w-4xl">
          ...
          <section className="mt-8 rounded-2xl border border-slate-200 bg-white p-6 shadow-sm sm:p-8">
            ...
            <p className="mt-4 text-sm leading-7 text-slate-600">
              Creating a different random password for every
              account can be difficult to do manually. A password
              generator can quickly create strings that are longer
              and less predictable than passwords based on common
              words, names, dates, or other personal information.
            </p>
            ...
            <div className="mt-6 grid gap-4 sm:grid-cols-2">
              <div className="rounded-xl bg-slate-50 p-5">
                ...
                <p className="mt-2 text-sm leading-6 text-slate-600">
                  Increasing password length generally increases
                  the number of possible combinations an attacker
                  must consider.
                </p>
              </div>
              ...
              <div className="rounded-xl bg-slate-50 p-5">
                ...
                <p className="mt-2 text-sm leading-6 text-slate-600">
                  Randomly selected characters avoid many
                  predictable patterns found in manually created
                  passwords.
                </p>
              </div>
          ...
          <section className="mt-8 rounded-2xl border border-slate-200 bg-white p-6 shadow-sm sm:p-8">
            ...
            <ul className="mt-5 list-disc space-y-3 pl-5 text-sm leading-7 text-slate-600">
              ...
              <li>
                Avoid names, birthdays, addresses, dictionary
                words, and predictable patterns.
              </li>
            ...
            <p className="mt-5 text-sm leading-7 text-slate-600">
              The strength indicator in this tool is an estimate
              based on password length and selected character
              categories. It should not be treated as a complete
          ...
          <section className="mt-8 rounded-2xl border border-slate-200 bg-white p-6 shadow-sm sm:p-8">
            ...
            <p className="mt-4 text-sm leading-7 text-slate-600">
              ...
              to obtain random values and uses those values to
              select characters from the character sets you choose.
            </p>
          ...
          <section className="mt-8 rounded-2xl border border-slate-200 bg-white p-6 shadow-sm sm:p-8">
            ...
            <p className="mt-4 text-sm leading-7 text-slate-600">
              As with other website features, site-wide services
              such as analytics may operate separately. Review the
