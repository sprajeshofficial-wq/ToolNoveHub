...
export const metadata: Metadata = {
  ...
  description: 'Contact ToolNoveHub for questions, feedback, bug reports, tool suggestions, and other inquiries.',
  alternates: {
    ...
    <main className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-indigo-50/30 px-4 py-20">
      <div className="mx-auto max-w-4xl">
            ...
            <div className="rounded-2xl border border-slate-200/50 bg-white/80 p-6 shadow-xl backdrop-blur-sm">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <a href="mailto:support@toolnovehub.tools" className="text-sm text-indigo-600 hover:underline">
            ...
            <div className="rounded-2xl border border-slate-200/50 bg-white/80 p-6 shadow-xl backdrop-blur-sm">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-slate-600">Serving users worldwide</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="mt-8 text-center text-sm text-slate-500">
          ...
          <Link href="/tools" className="text-indigo-600 hover:underline">All Tools</Link>
          <span className="mx-2">•</span>
